# -*- coding: utf-8 -*-
"""
Created on Tue Mar 22 20:20:25 2022
...
if __name__ == '__main__':
    ...
    for i in range(500):
        for j in range(5):
            if i < 10:
                mydir = "D:\\BaiduNetdiskDownload\\CASIA-FaceV5 (000-099)\\00{i}\\00{i}_{j}.bmp".format(i=i, j=j)
                face_data.append(ReadBMPFile(mydir))
            elif i < 100:
                mydir = "D:\\BaiduNetdiskDownload\\CASIA-FaceV5 (000-099)\\0{i}\\0{i}_{j}.bmp".format(i=i, j=j)
                face_data.append(ReadBMPFile(mydir))
            elif i < 500:
                mydir = "D:\\BaiduNetdiskDownload\\CASIA-FaceV5 (000-099)\\{i}\\{i}_{j}.bmp".format(i=i, j=j)
                face_data.append(ReadBMPFile(mydir))
    # R, G, B 三个通道 [0, 255]
    R = face_data.R
    G = face_data.G
